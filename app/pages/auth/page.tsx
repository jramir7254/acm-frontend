...
import { Calendar, Trophy, ClipboardList, CheckCircle2 } from "lucide-react";
...
export default function AuthPage() {
    return (
        <Page className="flex bg-[#232325] ">
            <aside className="w-[45vw] h-full  flex-col items-center justify-center hidden lg:flex">
                <div className=" bg-linear-to-br from-neutral-900/95 to-neutral-900/80 rounded-2xl size-full p-25  ">
