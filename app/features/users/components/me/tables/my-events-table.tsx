...
const EventRow = ({ data }: { data: UserEvent }) => {
    ...
    if (isPast) {
        if (data.semesterCreatedId !== cs?.id) {
            action = <Button disabled variant="outline">Past Event</Button>;

        }
        else if (data?.complete) {
            action = <Button disabled variant="outline">Complete</Button>;
        }
        ...
        action = <Button disabled variant="outline">Checked In</Button>;
