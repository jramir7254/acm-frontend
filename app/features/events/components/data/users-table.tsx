...
import { useEventAttendance, useEventField, useEventRsvps } from '../../hooks/event/queries'
import { Italic } from '@/components/text/typography'
import { CustomBadge, type BadgeConfig } from '@/components/other/custom-badge'
...
type EventDataHook = (eventId: number) => {
    data?: DataModel[]
    isLoading: boolean
}

const eventDataHooks: Record<DataType, EventDataHook> = {
    rsvps: useEventRsvps,
    attendance: useEventAttendance,
}
...
export function UsersTable({
    ...
    const useHook = eventDataHooks[field]
    const { data, isLoading } = useHook(eventId)
    ...
    return (
        <ScrollArea className=" max-h[500px] h-[500px] rounded-t-md ">
            ...
            <Table className="px-5 ">
                ...
                <TableBody className="border" isLoading={isLoading}>
